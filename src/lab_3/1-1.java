...
// возвращающие их скалярное произведение и длины. Вычислить и вывести углы между векторами.
...
class Lab1_1 {
    public static void main(String[] args) {
        ...
        Vector1[] matrix = {new Vector1(3), new Vector1(new double[]{3, 2, 1})};

        System.out.println(vector.scalarMultiply(matrix[0].getVector(), matrix[1].getVector()));
        System.out.println(matrix[0].module());
        System.out.println(matrix[1].module());
    }
...
class Vector1 {
    ...
    public double[] add(double[] rValue) {
        this.vector = Vector1.add(this.vector, rValue);
        return this.vector;
    }
    ...
    public double[] subtract(double[] rValue) {
        this.vector = Vector1.subtract(this.vector, rValue);
        return this.vector;
    }
    ...
    public double[] multiply(double k) {
        this.vector = Vector1.multiply(this.vector, k);
        return this.vector;
    }
    ...
    public double scalarMultiply(double[] rValue) {
        return Vector1.scalarMultiply(this.vector, rValue);
    }
    ...
    public static boolean isCollinear(double[] lValue, double[] rValue) throws UnsupportedOperationException {
        ...
        for (int i = 1; i < n; i++) {
            ...
            if (Math.abs(newK - k) > Vector1.epsilon) {
                return false;
            }
        }
    ...
    public static boolean isOrthogonal(double[] lValue, double[] rValue) {
        return Math.abs(Vector.scalarMultiply(lValue, rValue)) < Vector1.epsilon;
    }
